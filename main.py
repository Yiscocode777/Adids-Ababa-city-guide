...
def ዳታቤዙን_አዘምን():
    ...
    # 🌟 3. 60+ የአዲስ አበባ ዋና ዋና ሰፈሮች ዝርዝር (በቋሚነት በኮድ ውስጥ የገባ)
    ዋና_ቦታዎች = [
        # 🏛 ታሪካዊ እና የመዝናኛ ስፍራዎች
        ...
        ("ስድስት ኪሎ", "የሰማዕታት ሃውልት፣ የቅድስት ሥላሴ ካቴድራል እና ብሔራዊ ሙዚየም የሚገኙበት የታሪክ ማዕከል::", "5 ኮከብ", "🏛 ታሪካዊ እና የመዝናኛ ስፍраዎች"),
        ...
        ("አራት ኪሎ ኪሎ ሜትር", "ከታሪካዊው የድል ሃውልት ጀርባ የሚገኙ የመንግስት መሥሪያ ቤቶችና የትምህርት ተቋማት መገኛ::", "3 ኮከብ", "🏛 ታሪካዊ እና የመዝናኛ ስፍራዎች"),
        ...
        ("ሀያ ሁrequest (22)", "ደማቅ የምሽት ህይወት፣ ዘመናዊ ህንፃዎችና የንግድ ሱቆች የበዙበት የቦሌ አዋሳኝ ሰፈር::", "4 ኮከብ", "🛒 የንግድ ማዕከላት እና ገበያ"),
        ...
        ("ጎተራ", "በትላልቅ ዘመናዊ ኮንዶሚኒየሞችና በኢንተርክንቲኔንታል የልውውጥ ድልድይ የምትታወቅ የንግድ መገናኛ::", "4 ኮከብ", "🛒 የንግд ማዕከላት እና ገበያ"),
        ...
        ("ሜ canisa (Mecanisa)", "የውጭ ሀገር ዜጎችና ትላልቅ ትምህርት ቤቶች የሚገኙበት፣ ለኑሮ ምቹና ሰላማዊ ሰፈር::", "4 ኮከብ", "🏡 መኖሪያ እና ሌሎች ሰፈሮች"),
    ...
    for ስም, ታሪክ, ደረጃ, ምድብ in ዋና_ቦታዎች:
        ...
        # INSERT OR IGNORE መረጃው ቀድሞ ካለ ዝም ይላል፣ ከጠፋ ግን መልሶ ይሞላዋል
        ጠቋሚ.execute("INSERT OR IGNORE INTO ቦታዎች (ስም, ታሪክ, ደረጃ, ምድብ, 卡尔塔) VALUES (?, ?, ?, ?, ?)", 
                       (ስም, ታሪክ, ደረጃ, ምድብ, ዲፎልት_ካርታ))
        
    ግንኙነት.commit()
    ግንኙነት.close()

# ዳታቤዙን በ60 ሰፈሮች ሞልቶ ማስነሳት
ዳታቤዙን_አዘምን()
...
<body>
    <div class="container">
        ...
        <h2>የአዲስ አበባን ይወቁ</h2>
        <p class="subtitle">የከተማዋን {{ ምድቦች.values()|map('length')|sum }} ሰፈሮች እና መገኛቸውን ያስሱ</p>
